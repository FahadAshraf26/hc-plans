...
<html>
  <head>
    ...
    <style type="text/css">
      ...
      .invoice-payment-detail-promo-details {
        float: left;
        padding-left: 5%;
        clear: both;
      }
      .invoice-payment-detail-promo-details-amount {
        display: flex;
        padding-right: 6%;
        float: right;
      }
        ...
        <div class="invoice-box-container">
          ...
          <div class="invoice-detail-text-container">
            <div class="invoice-investor-detail-text">
              ...
              <br />
              <span class="invoice-investor-detail-value-text">{@FULL_NAME}</span>
              <br />
          ...
          <div style="clear: both"></div>
          <div class="invoice-payment-details-value-text">
            <div class="invoice-payment-detail-wallet-details">
              Honeycomb Wallet
            </div>
            <div class="invoice-payment-detail-wallet-details-amount">
              {@AMOUNT2}
            </div>
          </div>
          <div style="clear: both"></div>
          <div class="invoice-payment-details-value-text">
            <div class="invoice-payment-detail-promo-details">
              Promotional Credit
            </div>
            <div class="invoice-payment-detail-promo-details-amount">
              $5.00
            </div>
          </div>
          <div style="clear: both"></div>
          ...
          <div style="clear: both"></div>
          <div class="note">*Fees do not apply to promotional credits</div>
          <div style="clear: both"></div>
