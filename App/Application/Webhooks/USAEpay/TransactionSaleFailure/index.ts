import { ITransactionSaleFailure } from './ITransactionSaleFailue';
import {
...
@injectable()
class TransactionSaleFailure implements ITransactionSaleFailure {
  constructor(
...
export default TransactionSaleFailure;
