...
import { ISendLikedCampaignExpirationNotifyBeforeThirtyDaysUseCase } from '@application/PushNotifications/sendLikedCampaignExpirationNotifyBeforeThirtyDays/ISendLikedCampaignExpirationNotifyBeforeThirtyDaysUseCase';

@injectable()
class SendLikedCampaignExpirationNotifyBeforeThirtyDaysUseCase
  implements ISendLikedCampaignExpirationNotifyBeforeThirtyDaysUseCase {
  constructor(
  ...
  pushNotificationRecords(tickets, filteredUsers, body, campaign, filteredNotifications) {
  ...
  async execute({ campaign, users }) {
    ...
    const { title, body } = PushNotificationMessages.LikedCampaignReminder30Days;
...
export default SendLikedCampaignExpirationNotifyBeforeThirtyDaysUseCase;
